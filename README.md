...
1. **[Asin Omal](https://github.com/AsinOmal)** - Setup & Authentication
   - Project initialization
   - User authentication & JWT
   - CORS configuration
   - Security middleware

2. **[Chathumi Gurugamage](https://github.com/Chathumi01)** - Browsing & Menu System
   - Restaurant/Menu models & APIs
   - Search & filtering
   - Database seeding

3. **[Sasini Wijekoon](https://github.com/Sasini213)** - UI/UX & Polish
   - CSS styling & responsive design
   - Animations & visual assets
   - Empty state designs

4. **[Dimantha Seshan](https://github.com/Dimantha2003)** - Cart & Orders
   - Cart functionality
   - Order placement
   - Cart calculations

5. **[Rashini Dissanayake](https://github.com/rashini2002)** - Owner Dashboard
   - Dashboard layout & analytics
   - Menu management (CRUD)
   - Restaurant editing

6. **[Kalanapriya Mannage](https://github.com/Kalanapriya-Mannage)** - Real-time & Checkout
   - Socket.io integration
   - Real-time order tracking
   - Checkout page
  
7. **[Semini Budara](https://github.com/Semini-Budara)** - Testing & DevOps
   - Unit testing (Jest)
